package com.mypro.emoj;

import java.util.ArrayList;
import java.util.List;

import com.mypro.emoj.ChatEmoji;
import com.mypro.emoj.MessagePlusEndity;
//import com.mypro.emoj.FaceAdapter;
import com.mypro.emoj.FacePagerAdapter;
import com.mypro.emoj.MessagePlusAdapter;
import com.mypro.emoj.ViewPagerAdapter;
import com.mypro.emoj.FaceConversionUtil;
import com.mypro.paopao.R;
...
//		Toast.makeText(context, "clk", 0).show();
		switch (v.getId()) {
		case R.id.btn_face:
//			Toast.makeText(context, "biaoqing", 0).show();
			Init_viewPager();
			Init_Point();
			Init_Data();
			// 隐藏表情选择框
...
//		Toast.makeText(context, ""+emojis.size(),0).show();
